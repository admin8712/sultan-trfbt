...
def catch_all(path):
    # MENYESUAIKAN TIPE DATA (INT, BOOL, NULL) SESUAI LOG CANARY
    if 'config.php' in path or request.method == 'HEAD':
        return jsonify({
            ...
            "min_version": 25,
            "is_clean_pro": 1,          # Diubah ke 1 agar PRO
            "user_type": "pro",
            "subscription_until": None,  # Murni null sesuai Canary
            "wa_linked": True,
            "whatsapp_number": "6285161442237",
            "referral_code": "CBC1B335",
            "referred_by": None,
            "is_ref_changed": 1,
            "commission_balance": 0,
            "has_rated": 1,
            "bank_name": "BANK VERCEL",
